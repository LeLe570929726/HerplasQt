...
@Last Change Time: 2015/10/31 11:25
*/
...
@Name: OEventObject
@Intro: The base class with event bus
*/
class OEventObject : public OObject, public EEventObject {
public:
	/*
	...
	@Parameter: none
	@Return: none
	@Intro: OEventObject's constructor
	*/
	OEventObject();
	...
	@Parameter: none
	@Return: none
	@Intro: OEventObject's destructor
	*/
	virtual ~OEventObject() = default;
};